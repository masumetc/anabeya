        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Edit Commission</h4>
                </div>
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <form action="{{route('update.commission', $user->id)}}"  role="form" data-toggle="validator" method="post" accept-charset="utf-8" novalidate="true" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <!-- SmartWizard html -->
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="commission">Commition :</label>
                                                    <input type="text" class="form-control border-primary @error('commission') is-invalid @enderror" name="commission" value="{{$user->commission}}" required>
                                                    @error('commission')
