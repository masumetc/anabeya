...
<center>
    @foreach($log as $key=>$logImg)
      @if($key == 0)
    <!-- <img style="width:100%" src="{{URL::to('public/assets/images/lg.png')}}" alt="homepage" class="dark-logo" /> -->
    <!--<img src="{{URL::to('public/images/logo_img/',$logImg->image)}}" height="50px" width="100px" alt="homepage" class="dark-logo"/>-->
<!-- Light Logo icon -->
<!-- <center><img style="width:100%" src="{{URL::to('public/assets/images/lg.png')}}" alt="homepage" class="light-logo" /></center> -->
@endif
@endforeach
</center>
</b>
...
<!--    </li>-->
<!--    <li>-->
<!--        <a class="nav-link text-center link" href="javascript:void(0);"> <strong>Check all notifications</strong> <i class="ti-angle-right"></i> </a>-->
<!--    </li>-->
<!--</ul>-->
<!--</div>-->
<!--</li>-->
...
<ul>
    ...
    <li>
        <div class="message-center">
            <!-- Message -->
            <a href="javascript:void(0)">
                <div class="user-img"> <img src="{{URL::to('public/assets/images/users/1.jpg')}}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                <div class="mail-contnet">
