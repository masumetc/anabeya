                                    ...
                                    <table class="table product-overview" id="myTable">
                                        ...
                                        @foreach($orders as $order)
                                            <tr>
                                                ...
                                                @if(Auth::user()->role == 'superadmin')
                                                <td> 
                                                    <a href="{{route('uporder_four', $order->id)}}" class="label label-primary font-weight-100">Up</a>
                                                </td>
                                                @endif
                                                <td>
                                                @if(Auth::user()->role == 'curier')
                                                    <a href="{{route('order.deliverys', $order->id)}}" class="label label-danger font-weight-100">Order Delivery</a>
                                                @endif
