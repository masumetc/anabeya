        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">New Order</h4>
                </div>
                                    ...
                                    <table class="table product-overview" id="myTable">
                                        ...
                                        @foreach($orders as $order)
                                            <tr>
                                                ...
                                                @if(Auth::user()->role == 'superadmin')
                                                <td> 
                                                    <a href="{{route('uporder_three', $order->id)}}" class="label label-primary font-weight-100">Up</a>
                                                </td>
                                                @endif
                                                ...
                                                @if(Auth::user()->role == 'curier')
                                                    <a style="cursor:ponter;color:#fff" data-toggle="modal" data-target="#ship-modal" class="label label-danger font-weight-100">ship</a>
                                                      <!-- sample modal content -->
                                                        <div id="ship-modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                                    ...
                                                                    <form action="{{route('order.processing', $order->id)}}" method="post">
                                                                        <div class="modal-body">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="recipient-name" class="control-label">Tracking ID:</label>
                                                                                    <input type="text" class="form-control" name="tracking" id="recipient-name">
                                                                                </div>
                                            ...
                                            <div class="modal bs-example-modal-lg{{$order->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
