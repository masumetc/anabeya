                                    ...
                                    <table class="table product-overview" id="myTable">
                                        ...
                                        @foreach($orders as $order)
                                            <tr>
                                                ...
                                                <td>{{$order->price}}</td>
                                                <td>{{$order->quantity}}</td><td>{{$order->first_name}} {{$order->last_name}}</td>
                                                <td>{{$order->email}}</td>
                                                <td>{{$order->created_at}}</td>
                                                <td> <span class="label label-success font-weight-100">Paid</span>
                                                @if(Auth::user()->role == 'superadmin')
                                                <td> 
                                                    <a href="{{route('uporder_five', $order->id)}}" class="label label-primary font-weight-100">Up</a>
                                                </td>
                                                @endif
                                                <td> <span class="label label-success font-weight-100">Delivered</span> </td>
                                                <td>
