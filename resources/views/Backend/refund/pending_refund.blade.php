                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table product-overview" id="myTable">
                                        ...
                                        <tbody>
                                        @foreach($pending_refunds as $order)
                                            <tr>
                                                ...
                                                <td> <a href="{{route('execute_refund', $order->id)}}" class="label label-success font-weight-100">Ship to Success</a> </td>
                                                <td>
                                                @if(Auth::user()->role == 'curier')
                                                    <a href="{{route('order.ship_change', $order->id)}}" class="label label-danger font-weight-100">Receive</a>
                                                @endif
