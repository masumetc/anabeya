        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Add Currency</h4>
                </div>
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <form action="{{route('currency.store')}}"  role="form" data-toggle="validator" method="post" accept-charset="utf-8" novalidate="true" enctype="multipart/form-data">
                                    @csrf
                                    <!-- SmartWizard html -->
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control border-primary @error('currency_name') is-invalid @enderror" name="currency_name" value="">
                                                    @error('currency_name')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" disabled class="form-control border-primary @error('taka') is-invalid @enderror"  name="taka" value="1">
                                                    @error('taka')
                                                    <span style="color: red;">
                                                        <strong>{{ $message }}</strong>
                                                 </span>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control border-primary @error('symbol') is-invalid @enderror" name="symbol" value="">
                                                    @error('symbol')
                                                    <span style="color: red;">
                                                        <strong>{{ $message }}</strong>
                                                 </span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control border-primary @error('rate') is-invalid @enderror" name="rate" value="">
                                                    @error('rate')
                                                    <span style="color: red;">
                                                        <strong>{{ $message }}</strong>
                                                 </span>
